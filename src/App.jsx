...
function App() {
  return (
    <div
      className="d-f ac-c jc-c fw-w pos-f"
      style={{ top: 0, bottom: 0, right: 0, left: 0, overflowY: "auto" }}
    >
      <div className="w-100 ta-c" style={{ marginBottom: 30, marginTop: 60 }}>
        <svg
          style={{ maxWidth: "80%" }}
          width="359px"
          height="54px"
          ...
          >
            <g id="WordWeaver">
              <g id="Weaver" transform="translate(155.000000, 1.000000)">
                <path
                  d="M194.447894,33.1589189 C195.970752,31.4659459 197.96218,29.7145946 200.01218,29.7145946 C201.24218,29.7145946 202.355037,29.8897297 202.88218,30.0648649 L203.585037,23.1178378 C203.526466,23.1178378 202.589323,22.7675676 201.007894,22.7675676 C198.255037,22.7675676 196.439323,23.8767568 193.569323,26.2118919 L192.866466,23.3513514 L186.775037,23.3513514 L186.775037,52.5405405 L194.447894,52.5405405 L194.447894,33.1589189 Z"
                  id="r"
                  fill-opacity="0.85"
                  fill="#5A35F0"
                ></path>
                <path
                  d="M181.568346,50.7308108 C177.351203,52.3654054 174.598346,52.8908108 171.259774,52.8908108 C162.239774,52.8908108 157.495489,48.2789189 157.495489,38.0627027 C157.495489,27.9632432 162.122631,22.7675676 170.556917,22.7675676 C177.292631,22.7675676 182.15406,26.8540541 182.15406,35.7275676 C182.15406,37.0118919 182.095489,38.7632432 181.919774,40.2227027 L164.992631,40.2227027 C164.992631,45.0097297 167.921203,46.9362162 171.90406,46.9362162 C174.305489,46.9362162 176.82406,46.4691892 180.279774,45.5351351 L181.568346,50.7308108 Z M174.832631,34.8518919 L174.832631,34.4432432 C174.832631,31.1156757 173.485489,28.4886486 169.971203,28.4886486 C166.398346,28.4886486 164.992631,31.5827027 164.93406,34.8518919 L174.832631,34.8518919 Z"
                  id="e2"
      ...
      <div className="w-100 ta-c" style={{ marginBottom: 15 }}>
        <img
          src="/gameplay-sample.gif"
          alt="Gameplay Sample"
          style={{
            borderRadius: 3,
            boxShadow: "0 2px 140px -20px rgba(0,0,0,.7)",
            maxWidth: "90%",
          }}
        />
      </div>
      <div className="w-100" id="firebaseui-auth-container">
        <div className="firebaseui-container firebaseui-page-provider-sign-in firebaseui-id-page-provider-sign-in">
            ...
            <div>
              <ul className="firebaseui-idp-list">
                <li className="firebaseui-list-item">
                  ...
                  <div
                    className="ta-c"
                    style={{ color: "#445566", fontSize: 10 }}
                  >
                    <a
                      target="_blank"
                      style={{ color: "#445566" }}
